...
O Banco Nacional de Desenvolvimento Econômico e Social (BNDES) lançou nesta quarta-feira (11) com o Banco Interamericano de Desenvolvimento (BID), o Banco Nacional de Obras y Servicios Públicos S.N.C., do México (Banobras) e a Alide, uma associação que reúne bancos de desenvolvimento da América Latina, a plataforma Latam Projects Hub.
...
Segundo o banco, há uma área na [**homepage do portal**](http://www.latamprojectshub.org/) para filtrar projetos por país, setor, tipo de projeto e status. Quem clicar em um projeto de interesse terá também acesso a uma ficha com informações de destaque.

“Por meio das fichas de projeto a plataforma está conectada com o [**hub **](https://projectshub.bndes.gov.br/)de Projetos BNDES e com o [**hub mexicano**](http://www.proyectosmexico.com/) patrocinado pelo Banobras. A mesma lógica se aplicará aos futuros participantes”, indicou a instituição.
