...
A adesão poderá ser feita no portal[** Regularize**](http://www.regularize.pgfn.gov.br/). Basta o devedor clicar na opção Acessar Serviços ou usar o login único do Portal gov.br e clicar na opção Negociação de Dívida. Em seguida, o contribuinte preencherá um formulário eletrônico e saberá se está apto à renegociação e receberá uma proposta de adesão.
...
[**A PGFN forneceu uma tabela para o contribuinte**](http://gov.br/pgfn/pt-br/servicos/orientacoes-contribuintes/acordo-de-transacao/acordos-de-transacao-da-pgfn-2013-tabela-comparativa) consultar as diferenças de cada modalidade de acordo.
