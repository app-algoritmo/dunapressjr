...
Para saber se a restituição está disponível, o contribuinte deve acessar a [**página da Receita **](http://www.gov.br/receitafederal)na internet, selecionar em Meu Imposto de Renda e, em seguida, em Consultar a Restituição. A página apresenta orientações e os canais de prestação do serviço, permitindo a consulta simplificada ou completa da situação da declaração, por meio do extrato de processamento, acessado no e-CAC.
