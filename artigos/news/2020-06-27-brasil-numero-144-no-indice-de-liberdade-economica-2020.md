...
## DOC: [Ranking Mundial de Liberdade Econômica](https://dunapress.org/wp-content/uploads/2020/06/Brasil-144-ranking-mundial-de-liberdade-economica-2020.pdf)

**Gráfico comparativo - Brasil | Noruega**

.embox{display: inline-block;position:  relative;width: 100%;margin: 0px;float: left;font-size: 12px;}.embox:before{content: "";display: block;padding-top: 100%;}.ratio16_9:before{padding-top: 56.25%;}.emcontent{position:  absolute;top: 0;left: 0;bottom: 0;right: 0;width:100%;height:100%;}

### DOC: [Índice Mundial](https://dunapress.org/wp-content/uploads/2020/06/2020_IndexofEconomicFreedom_Highlights.pdf)
...
- [Capítulo 1: Principais conclusões do índice 2020](https://www.heritage.org/index/book/chapter-1)
- [Capítulo 2: 12 Liberdades Econômicas: Políticas de Progresso e Prosperidade](https://www.heritage.org/index/book/chapter-2)
- [Capítulo 3: A luta pelo livre comércio](https://www.heritage.org/index/book/chapter-3)
- [Capítulo 4: Cadeias de suprimentos: a odisseia de uma Honda](https://www.heritage.org/index/book/chapter-4)
...
- **Estado de direito** (direitos de propriedade, integridade governamental, eficácia judicial)
- **Tamanho do** governo (gastos do governo, carga tributária, saúde fiscal)
- **Eficiência regulatória** (liberdade empresarial, liberdade trabalhista, liberdade monetária)
- **Mercados abertos** (liberdade comercial, liberdade de investimento, liberdade financeira)
...
O *Índice de Liberdade Econômica* pode ser facilmente explorado usando uma variedade de ferramentas em nosso site interativo, incluindo:

- [Classificação por país](https://www.heritage.org/index/ranking) : veja a classificação do país no Índice e a comparação com seus pares e acompanhe os desenvolvimentos políticos e econômicos na página de cada país.
- [Faça um gráfico dos dados](https://www.heritage.org/index/visualize) : personalize e compare as pontuações de países em até três países usando gráficos interativos.
- [Explore os dados](https://www.heritage.org/index/explore) : faça o download de mais de 20 anos de dados históricos do Índice, incluindo indicadores macroeconômicos, e um detalhamento regional das pontuações do Índice desde 1995.
- [Mapa de Calor](https://www.heritage.org/index/heatmap) : visualize o Índice de Liberdade Econômica 2020 neste mapa impressionante e interativo do mundo. Descubra como sua região é competitiva para alcançar os ideais de liberdade econômica.
- [Downloads](https://www.heritage.org/index/download) : Faça o download do livro inteiro do Index of Economic Freedom ou escolha capítulos individuais, a metodologia ou mapas regionais.

### Q.7 Como posso usar o *Índice de Liberdade Econômica* ?

O *Índice de Liberdade Econômica* é uma ferramenta útil para uma variedade de públicos, incluindo acadêmicos, formuladores de políticas, jornalistas, estudantes, professores e profissionais de negócios e finanças. O Índice é uma excelente ferramenta objetiva para analisar 186 economias em todo o mundo e a página de cada país é um recurso para uma análise aprofundada dos desenvolvimentos políticos e econômicos de um país. As 12 liberdades econômicas e os dados históricos que os acompanham também fornecem um conjunto abrangente de princípios e fatos para aqueles que desejam entender os fundamentos do crescimento econômico e da prosperidade.

Fonte: HERITAGE - Imagem em destaque Captura de tela Heritage

## Ver também

https://dunapress.org/2020/06/25/brasil-numero-107-no-ranking-mundial-de-liberdade-de-imprensa-2020/
