...
Uma segunda vertente do estudo analisou em laboratório os efeitos causados por esses agrotóxicos em um modelo de membrana plasmática. A membrana é a primeira via de acesso de um contaminante a uma célula, seja em um sistema aquático, seja no organismo do ser humano.

Para o pesquisador, o reconhecimento oferecido pela CAPES ajuda os brasileiros a serem inseridos no mundo da ciência, uma vez que a divulgação dos trabalhos vencedores evidencia um pouco do que uma universidade pública, com financiamento, pode fazer pelo Brasil. “É por meio desse tipo de incentivo que podemos transformar e melhorar a cultura do nosso País”, conclui Rubira.
