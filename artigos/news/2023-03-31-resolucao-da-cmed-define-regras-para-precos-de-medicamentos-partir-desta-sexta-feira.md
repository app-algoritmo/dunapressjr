...
De acordo com a Resolução, as empresas produtoras de medicamentos poderão ajustar os preços de seus produtos a partir do dia 31 de março, tendo como referência o mais recente Preço Fábrica (PF) publicado na lista de preços constante do sítio eletrônico da CMED no Portal da Agência Nacional de Vigilância Sanitária (Anvisa).

O ajuste de preços dos medicamentos é baseado em um modelo de teto de preços, que leva em conta o Índice Nacional de Preços ao Consumidor Amplo (IPCA), em um fator de produtividade, em uma parcela de fator de ajuste de preços relativos intrassetor e em uma parcela de fator de ajuste de preços relativos entre setores.

Para o ano de 2023, o ajuste máximo de preços permitido será de 5,60% para o Nível 1, 5,60% para o Nível 2 e 5,60% para o Nível 3.

As empresas produtoras de medicamentos que desejarem fazer jus ao ajuste de preços deverão apresentar o Relatório de Comercialização à CMED até o dia 10 de abril de 2023. As informações contidas no Relatório de Comercialização serão objeto de tratamento confidencial, na forma da lei.

O Preço Fábrica (PF) será obtido por meio da aplicação dos fatores previstos na tabela constante do Anexo I da Resolução, observadas as cargas tributárias do Imposto sobre Operações relativas à Circulação de Mercadorias e sobre Prestação de Serviços de Transporte Interestadual, Intermunicipal e de Comunicação (ICMS) praticadas nos Estados de destino e a incidência da contribuição ao Programa de Integração Social (PIS), ao Programa de Formação do Patrimônio do Servidor Público (Pasep) e à Contribuição para Financiamento da Seguridade Social (Cofins).
