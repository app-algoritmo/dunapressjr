...
No vazamento mais grave, foram expostas [**informações de mais de 220 milhões**](https://agenciabrasil.ebc.com.br/justica/noticia/2021-01/oab-pede-investigacao-do-vazamento-de-dados-de-220-milhoes-de-pessoas) de brasileiros, vivos e mortos.
...
Um caminho para contornar a situação é o [**Registrato**](http://www3.bcb.gov.br/registrato), sistema do BC que fornece um extrato das informações de uma pessoa com instituições financeiras.
...
1. O cidadão deve credenciar-se no site do [**Banco Central**](http://www3.bcb.gov.br/registrato). É preciso fornecer CPF, data de nascimento e primeiro nome da mãe.
...
1. Concluído o cadastro, o cidadão pode entrar no site do [**Registrato**](http://www3.bcb.gov.br/registrato) e consultar o histórico de relacionamento com instituições financeiras. Basta usar o CPF e a senha criada anteriormente para fazer o login.
...
Fonte: Agência Brasil – Imagem de destaque: Divulgação/Receita Federal
