...
**Como solicitar**
 A solicitação do BEm deve ser feita pelo empregador diretamente no link ([https://servicos.mte.gov.br/bem/#empregador](https://servicos.mte.gov.br/bem/#empregador)). O trabalhador pode acompanhar o processamento do pedido por meio do endereço [https://servicos.mte.gov.br/#/trabalhador](https://servicos.mte.gov.br/#/trabalhador) e pelo aplicativo Carteira de Trabalho Digital.
...
Quando não for identificada conta poupança em nome do trabalhador ou houver algum impedimento para a realização do crédito, será aberta de forma automática uma Conta Poupança Social Digital em nome do trabalhador. Para a movimentação da Conta Poupança Social Digital, o cliente tem à sua disposição, de forma gratuita:
	...
	- aplicativo para celular CaixaTem para realizar transações de pagamentos de contas e de boletos, consultas e emissão de dois extratos por mês, transferências ilimitadas entre contas Caixa e três transferências por mês para outros bancos;
