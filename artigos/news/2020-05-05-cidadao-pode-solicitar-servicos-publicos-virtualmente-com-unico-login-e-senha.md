...
O Governo Federal tem acelerado a digitalização de serviços públicos para facilitar a vida do cidadão, em especial de quem precisa evitar deslocamentos devido à Covid19. Desde o começo da pandemia, cresceu o número de serviços transformados em digitais no portal [gov.br](http://gov.br/), ferramenta que permite o uso de um único login e senha. O encadeamento dessas soluções resulta agora na marca de 60 milhões de pessoas cadastradas no login único do Governo Federal.
