...
As[ opções em renda variável](https://www.genialinvestimentos.com.br/onde-investir/renda-variavel/) incluem ações de diferentes empresas, câmbio, derivativos, fundos de investimentos imobiliários (FIIs), fundos de índice (ETFs), fundos de ações, fundos multimercados, BDRs e criptomoedas.
