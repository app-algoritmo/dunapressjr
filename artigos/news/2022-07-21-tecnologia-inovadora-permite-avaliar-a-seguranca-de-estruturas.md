...
O pesquisador Valder Steffen Júnior, do Laboratório de Mecânica de Estruturas (LMEst), da Faculdade de Engenharia Mecânica da Universidade Federal de Uberlândia (UFU) – que desenvolve tecnologias que observam continuamente o comportamento dinâmico de estruturas, com a colaboração da equipe do Instituto Nacional de Ciência e Tecnologia de Estruturas Inteligentes para Engenharia (INCT-EIE) –, liderou a criação de um método de SHM baseado na '[impedância eletromecânica](https://canalciencia.ibict.br/ciencia-em-sintese1/engenharias/235-tecnologia-inovadora-permite-avaliar-a-seguranca-de-estruturas#)'. O método é resultado de um projeto de desenvolvimento tecnológico e industrial, realizado em parceria com a Empresa Brasileira de Aeronáutica (Embraer).

## Como é feita a pesquisa?

O método da impedância eletromecânica, desenvolvido pela UFU, utiliza um aparelho construído pelos pesquisadores, o impedancímetro, no qual sensores chamados de [transdutores piezelétricos](https://canalciencia.ibict.br/ciencia-em-sintese1/engenharias/235-tecnologia-inovadora-permite-avaliar-a-seguranca-de-estruturas#), de pequenas dimensões  e baixo custo, avaliam a integridade da estrutura. Uma tensão elétrica em alta frequência é enviada a esses sensores que excitam a estrutura. Esta, por sua vez, sofre uma deformação que será percebida pelos transdutores através de um dispositivo acoplado a um computador (figura 1). Essa resposta da estrutura à tensão elétrica, chamada de assinatura de impedância, é obtida a partir de um software, também desenvolvido pela UFU, dedicado ao processamento dos dados, que fornece as informações referentes ao diagnóstico da integridade da estrutura. Quando a estrutura apresenta um dano, como uma trinca, os transdutores são capazes de detectar essa alteração a partir da tensão elétrica. A alteração causa uma mudança na resposta, a qual manifesta-se como uma variação na assinatura de impedância obtida da estrutura intacta.

Por meio de técnicas de processamento de dados e estatísticas, é possível calcular um índice de dano associado à medição realizada. Um índice com valor considerado crítico indica a presença de dano, que poderá provocar  alteração na estrutura ou no seu funcionamento. 
...
[Valder Steffen Júnior](mailto:inct-eie@mecanica.ufu.br)

Instituição(ões)

[Faculdade de Engenharia Mecânica da Universidade Federal de Uberlândia (UFU)](http://www.ufu.br/)

Sugestões de leitura

[Projeto da Universidade Federa lde Uberlância pretende prevenir acidentes com aviões.](http://g1.globo.com/minas-gerais/triangulo-mineiro/noticia/2012/12/projeto-da-ufu-pretende-prevenir-acidentes-com-avioes-em-uberlandia.html)
