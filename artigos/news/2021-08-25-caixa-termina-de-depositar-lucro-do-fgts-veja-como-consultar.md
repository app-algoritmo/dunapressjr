...
No último dia 17, o Conselho Curador do FGTS decidiu [**distribuir aos trabalhadores R$ 8,129 bilhões**](https://agenciabrasil.ebc.com.br/economia/noticia/2021-08/caixa-distribuira-r-81-bilhoes-em-lucros-do-fgts-ate-o-fim-do-mes) decorrentes do lucro líquido do fundo no ano passado. O montante equivale a 96% do ganho de R$ 8,467 bilhões obtido pelo FGTS em 2020. O depósito estava previsto para ocorrer até o fim do mês, mas foi concluído uma semana antes do prazo.
...
O trabalhador tem dois meios principais para verificar o saldo do FGTS. O primeiro é o aplicativo FGTS, disponível para os telefones com sistema [**Android**](https://play.google.com/store/apps/details?id=br.gov.caixa.fgts.trabalhador&hl=pt_BR&gl=US) e [**iOS**](https://apps.apple.com/br/app/fgts/id1038441027). O segundo é a consulta do extrato do fundo, no [**site da Caixa**](https://www.caixa.gov.br/beneficios-trabalhador/fgts/extrato-fgts/PAGINAS/DEFAULT.ASPX).
