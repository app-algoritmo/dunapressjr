---
title: "Prazo para autodeclaração de caminhoneiros é prorrogado para dia 12"
date: 2022-09-03
status: publish
author: "Joabson João"
categories:
...
“Todos os profissionais nessa situação estão com uma notificação nos sistemas do Ministério do Trabalho e Previdência (MTP). E poderão utilizar esses mesmos canais para fazer a autodeclaração. O acesso pode ser feito pelo [**Portal Emprega Brasil**](https://empregabrasil.mte.gov.br/), utilizando o *login* do Gov.br, no *[**link**](https://servicos.mte.gov.br/)* serviços, ou pelo aplicativo da Carteira de Trabalho Digital. O documento dará mais segurança e transparência à utilização dos recursos públicos”, explica o ministério.
