...
O procedimento é realizado no [Sistema Integrado de Produtos e Estabelecimentos Agropecuários](http://sistemasweb.agricultura.gov.br/pages/SIPEAGRO.html) (Sipeagro), que permite ao servidor do Ministério da Agricultura, Pecuária e Abastecimento (Mapa) assinar eletronicamente o documento. A empresa pode imprimir ou gerar o documento em PDF diretamente da plataforma online, tendo ainda o código para verificação da autenticidade do certificado via web.
