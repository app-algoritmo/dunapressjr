...
Em vista disso, é preciso criar uma rotina listando todas as operações da empresa com o propósito de entender mais profundamente o [comportamento do consumidor](https://www.zendesk.com.br/blog/comportamento-do-consumidor/) e definir estratégias certeiras.
...
Em outros termos, é o ato de analisar as [negociações da companhia](https://www.zendesk.com.br/blog/tipos-de-negociacao/) sob um olhar de diferentes variáveis para que se encontre as respostas corretas e uma visão mais abrangente.
...
Em resumo, um [relatório de vendas](https://www.zendesk.com.br/blog/como-fazer-relatorio-vendas/), a aplicação de métricas, a avaliação de** resultados de vendas** e a segmentação de clientes podem ser considerados uma análise descritiva.
...
A **análise prescritiva** é subsequente à [análise preditiva](https://www.zendesk.com.br/blog/marketing-preditivo/), sendo ela uma espécie de recomendação dada em cima de algo que pode acontecer.
...
É essencial que no momento de [definir suas metas](https://www.zendesk.com.br/blog/metas-de-vendas/) você seja objetivo e conciso para que os dados de venda realmente possam ser usados na sua estratégia.
...
Um bom [sistema de CRM](https://www.zendesk.com.br/blog/plataforma-crm/) é capaz de otimizar essas análises e fornecer relatórios para os seus clientes em tempo real.
...
Por fim, é crucial que com base nos relatórios obtidos você seja capaz de gerar gráficos. Pois eles f**acilitam o entendimento sobre o que você quer extrair daquele relatório.**
