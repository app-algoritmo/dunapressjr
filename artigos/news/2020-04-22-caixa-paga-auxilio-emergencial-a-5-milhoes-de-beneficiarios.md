...
Mais de 5 milhões de brasileiros recebem hoje (22) o equivalente a cerca de R$ 4,3 bilhões de auxílio emergencial. O lote de beneficiários inscritos no Cadastro Único para Programas Sociais (CadÚnico) foi enviado no último domingo (19) pela Empresa de Tecnologia e Informações da Previdência (Dataprev).

E a partir de amanhã (23) a Caixa inicia o pagamento da segunda parcela para os inscritos no CadÚnico, de acordo com o mês de nascimento do beneficiário:
...
Para os inscritos no CadÚnico, a consulta do resultado da análise realizada pela Dataprev pode ser feita desde segunda-feira (20) no aplicativo. Se o cidadão inscrito no CadÚnico tiver sido reprovado pela Dataprev, poderá solicitar nova avaliação através do cadastramento no aplicativo no celular ou [*site*](http://auxilio.caixa.gov.br/). 
...
O banco disponibilizou no [*endereço* ](http://www.caixa.gov.br/tutorial-1)passo a passo de cadastramento no aplicativo Caixa Tem para facilitar a utilização pelos clientes.
