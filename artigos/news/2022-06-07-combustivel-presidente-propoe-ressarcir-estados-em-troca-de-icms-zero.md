...
Para ser viabilizada, a proposta do governo precisa assegurar a aprovação do projeto que limita a aplicação de alíquota do ICMS sobre bens e serviços relacionados a combustíveis, gás natural, energia elétrica, comunicações e transporte coletivo. O projeto de lei complementar (PLP), que passou pela Câmara e agora[** está em análise no Senado**](https://agenciabrasil.ebc.com.br/politica/noticia/2022-06/projeto-que-limita-icms-de-combustiveis-pode-ser-votado-semana-que-vem), fixa a alíquota desse imposto em, no máximo 17% sobre esses setores, e também prevê mecanismos de compensação aos estados.
