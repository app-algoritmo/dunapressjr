...
Nos casos em que houve reincidência, os agentes tiveram as atividades suspensas por prazos que variam entre cinco e 30 dias. Para evitar problemas e se resguardar, o consumidor também pode verificar se o correspondente bancário é certificado e está apto a oferecer crédito consignado em nome dos bancos. A consulta é realizada por meio do CPF do profissional na base de dados da [**Central de Registros de Certificados Profissionais (CRCP)**](http://suporte.aneps.org.br/crcp/).
...
Outra medida do Sistema de Autorregulação do Consignado é a plataforma [**Não Me Perturbe**](https://www.naomeperturbe.com.br/). Por meio da ferramenta, os consumidores podem proibir que instituições financeiras e correspondentes bancários façam contato proativamente para oferecer crédito consignado.
