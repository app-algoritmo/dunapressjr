...
A CVM, autarquia federal responsável pela regulação do mercado de capitais no Brasil, informou também sobre a abertura de três processos administrativos em diferentes superintendências e áreas de atuação da autarquia. Segundo a CVM, cabe a ela garantir o funcionamento eficiente do Mercado de Capitais e preservar um ambiente propício aos princípios constitucionais para todos os agentes de mercado.
