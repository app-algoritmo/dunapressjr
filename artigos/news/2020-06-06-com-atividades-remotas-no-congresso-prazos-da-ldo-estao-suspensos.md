...
A proposta da LDO de 2021, encaminhada pelo governo em meados de abril, trouxe uma [meta flexível](https://agenciabrasil.ebc.com.br/politica/noticia/2020-04/projeto-da-ldo-de-2021-propoe-metas-fiscais-flexiveis-para-proximo-ano). Em vez de trazer um valor definido de déficit primário (resultado negativo nas contas do governo sem os juros da dívida pública), o projeto da Lei de Diretrizes Orçamentárias (LDO) de 2021 permitirá que estimativas de arrecadação e do teto de gastos, atualizadas periodicamente, sejam usadas para definir uma meta fiscal ajustável.

Fonte: Agência Brasil – Imagem de destaque: Edilson Rodrigues/Agência Senado
