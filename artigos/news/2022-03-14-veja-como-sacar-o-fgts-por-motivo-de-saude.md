...
A relação de documentos necessários e formulários a serem preenchidos em caso de solicitação do benefício pode ser consultada diretamente na [**página da Caixa**](https://www.caixa.gov.br/beneficios-trabalhador/fgts/condicoes-e-documentos-para-saque-do-FGTS/Paginas/default.aspx) na internet. Essa solicitação tanto pode ser feita presencialmente nas agências da Caixa quanto pela internet e aplicativos para dispositivos eletrônicos, como *tablets* e smartphones. 
