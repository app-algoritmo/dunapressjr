...
É nesse contexto que, em conjunto com a Agência Nacional de Telecomunicações (Anatel), as empresas abaixo assinadas apresentam este compromisso público, com medidas para **manter o** **Brasil Conectado**, de modo que o País possa atravessar a atual crise da melhor forma possível. Este [Compromisso](https://cloud.anatel.gov.br/index.php/s/zAYa8yLecTDk4Fx) permanece aberto para adesão de novos signatários
