...
No evento, Campos Neto também disse que atualmente o “grande ativo do sistema financeiro é o controle de dados”, ao falar sobre a implementação do *open banking* (compartilhamento de dados e serviços bancários, com autorização dos clientes, entre instituições financeiras por meio da integração de plataformas e infraestruturas de tecnologia), no Brasil. O [**BC**](https://agenciabrasil.ebc.com.br/economia/noticia/2020-05/banco-central-regulamenta-open-banking-no-brasil) defende que a implementação do *open banking* dará oportunidade para os clientes encontrem serviços mais vantajosos.
