...
O Banco Central (BC) publicou, nesta quinta-feira (23), a [Resolução BCB nº 294](https://www.bcb.gov.br/estabilidadefinanceira/exibenormativo?tipo=Resolu%C3%A7%C3%A3o%20BCB&numero=294), alterando pontos da Resolução nº 32, que estabelece requisitos técnicos e procedimentos operacionais para a implementação do Open Finance no Brasil. As mudanças referem-se a ajustes de forma e esclarecimentos, sendo o principal deles trazer maior clareza quanto ao escopo do monitoramento atribuído à Estrutura de Governança responsável pela implementação do Open Finance. Já é previsto que a Resolução nº 32 passe por revisões periódicas a fim de refletir a própria evolução do ecossistema.
