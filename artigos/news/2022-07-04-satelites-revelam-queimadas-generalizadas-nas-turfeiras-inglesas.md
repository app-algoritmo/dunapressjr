...
Viemos aqui para testar a profundidade da turfa, como parte de uma grande investigação sobre o impacto dessa nova proibição. O governo [diz que](https://www.gov.uk/government/news/englands-national-rainforests-to-be-protected-by-new-rules) suas novas regras visam proteger os pântanos da Inglaterra – um habitat delicado de importância internacional – e ajudar o Reino Unido a atingir zero emissões líquidas de carbono até 2050. Essas turfeiras são o maior estoque de carbono natural em terras britânicas. A queima rotacional seca a turfa e [corrói sua capacidade](https://www.ceh.ac.uk/sites/default/files/Peatland%20factsheet.pdf) de manter o carbono bloqueado para fora da atmosfera e fornecer proteção contra inundações. Mas cientistas e ativistas dizem que a proibição não vai longe o suficiente, está repleta de brechas arbitrárias e será muito difícil de policiar. 
...
- Mais de 40 dos incidentes de queima identificados na análise da *Unearthed* ocorreram em terras mapeadas como brejo pelos [dados da Natural England](https://data.gov.uk/dataset/4b6ddab7-6c0f-4407-946e-d6499f19fcde/priority-habitat-inventory-england) – o habitat que o governo diz que a legislação é mais projetada para proteger. O incêndio na charneca de Appletreewick foi um deles. 
...
Para descobrir se os incêndios podem ser uma violação da proibição, esta evidência de satélite foi mapeada contra vários conjuntos de dados espaciais publicados pela Natural England: para profundidade de turfa, usamos o banco de [dados de solos turfosos](https://data.gov.uk/dataset/c9eb1cd9-c254-4128-a18d-d368fbe6acf0/peaty-soils-location) , para habitat de turfeiras, usamos o [inventário de habitats prioritários](https://data.gov.uk/dataset/4b6ddab7-6c0f-4407-946e-d6499f19fcde/priority-habitat-inventory-england) do governo e para zonas de conservação, usamos bancos de dados em [Sítios de Interesse Científico](https://data.gov.uk/dataset/5b632bd7-9838-4ef2-9101-ea9384421b0d/sites-of-special-scientific-interest-england) Especial , [Áreas Especiais de Conservação](https://data.gov.uk/dataset/a85e64d9-d0f1-4500-9080-b0e29b81fbc8/special-areas-of-conservation-england) e [Áreas de Proteção Especial](https://data.gov.uk/dataset/174f4e23-acb6-4305-9365-1e33c8d0e455/special-protection-areas-england) da Inglaterra . Também adicionamos o [mapa World Slope GMTED](https://www.arcgis.com/home/item.html?id=1f34944490cd43c59d379773d4b7f052) , publicado pela ESRI, para verificar o gradiente do terreno. 

Finalmente, para verificar a propriedade da terra, usamos o conjunto de [dados de polígonos do INSPIRE Index do Registro de Terras](https://www.gov.uk/guidance/inspire-index-polygons-spatial-data) , com referência cruzada com [um mapa de propriedade de grouse moor](https://www.google.com/maps/d/u/0/viewer?mid=1BGhsQXh2-gJ9n85ZY_5WRgSkdfg2c4_y&ll=54.54514932804699%2C-2.2846084180968083&z=8) publicado pelo ativista Guy Shrubsole. Também obtivemos imagens de drones de incêndios e cicatrizes de queimaduras, além de testar a profundidade da turfa em algumas propriedades, e trabalhamos com o grupo de campanha Wild Moors, que cruzou as referências dos 51 locais identificados com seu banco de dados de relatórios de voluntários. 
