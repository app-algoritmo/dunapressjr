...
## Consulta fica disponível nesta terça-feira (10) a partir das 10 h.

O Sistema de Valores a Receber (SVR) será reaberto em 7 de março, às 10h, e trará novidades importantes, como impressão de telas, sala de espera virtual e consulta de valores de pessoa falecida. Antes disso, já a partir desta terça-feira (28), às 10 horas, será possível consultar se há valores a receber no sistema financeiro. 

## Neste retorno, o BC implementou algumas importantes melhorias para os usuários: 
...
a.contas corrente ou poupança encerradas com saldo disponível;

b.cotas de capital e rateio de sobras líquidas de ex-participantes de cooperativas de crédito;

c.recursos não procurados de grupos de consórcio encerrados; 

d.tarifas cobradas indevidamente;

e.parcelas ou despesas de operações de crédito cobradas;

Nesta nova fase, também foram incluídas as seguintes consultas:

f.contas de pagamento pré ou pós-paga encerradas com saldo disponível;

g.contas de registro mantidas por corretoras e distribuidoras encerradas com saldo disponível; e

h.outros recursos disponíveis nas instituições para devolução. 
...
## Segue as observações que devem ser feitas:
