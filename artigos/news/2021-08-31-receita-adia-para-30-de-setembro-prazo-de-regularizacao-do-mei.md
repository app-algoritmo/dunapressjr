...
Os débitos sob cobrança podem ser consultados no [**Programa Gerador do DAS para o MEI**](http://www8.receita.fazenda.gov.br/simplesnacional/servicos/grupo.aspx?grp=8). Por meio de certificado digital ou do código de acesso, basta clicar na opção "Consulta Extrato/Pendências" e, em seguida, em "Consulta Pendências no Simei". O Documento de Arrecadação do Simples Nacional (DAS) para quitar as pendências pode ser gerado tanto pelo *site *quanto por meio do Aplicativo MEI, disponível para celulares Android ou iOS.
