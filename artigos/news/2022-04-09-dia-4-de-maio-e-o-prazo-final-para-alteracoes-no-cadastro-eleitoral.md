...
No caso da apresentação de certificado de quitação militar, segundo a [Resolução TSE nº 23.659/2021](https://www.tse.jus.br/legislacao/compilada/res/2021/resolucao-no-23-659-de-26-de-outubro-de-2021), artigo 35:  somente é obrigatória para alistandos do gênero masculino que pertençam à classe dos conscritos", ou seja, para os brasileiros nascidos entre 1º de janeiro e 31 de dezembro do ano em que completarem 19 anos de idade, os quais compõem a classe chamada para a seleção, tendo em vista a prestação do Serviço Militar inicial.
...
Assista ao [vídeo](https://www.youtube.com/watch?v=Lf-gPVM-h2E) da TV TSE e veja um tutorial.
...
Veja o [vídeo](https://www.youtube.com/watch?v=0iDU367gDho) produzido pela TV TSE e aprenda como incluir o nome social no título eleitoral.

**Consulte a situação eleitoral**

Em “Autoatendimento do Eleitor”, você deve clicar em “Atendimento ao Eleitor” e buscar pela opção “Consulta a situação do título de eleitor”. Na tela seguinte, você deve informar nome completo, CPF ou o número do título e clicar em “Entrar”.
...
Ficou com dúvida? Então assista ao [vídeo](https://www.youtube.com/watch?v=5JqCyBhL7L8) da TV TSE e regularize já seu título eleitoral.

**Acompanhe o requerimento pela internet**

Completadas as etapas anteriores, basta aguardar a análise do pedido pela Justiça Eleitoral. O processo também pode ser acompanhado pela internet na opção [**“Acompanhar Requerimento”**](https://cad-app-titulonet.tse.jus.br/titulonet/acompanharRequerimento) e informando o número do protocolo gerado na primeira fase do atendimento.

**Baixe o e-Título**

Após o processamento dos dados, se não houver qualquer pendência, é só baixar o aplicativo [**e-Título**](https://www.tse.jus.br/eleitor/servicos/aplicativo-e-titulo) no celular ou *tablet* e utilizar a versão digital do documento, dispensando-se o título em papel.

O *download* do app é gratuito e pode ser feito pelo [**Google Play**](https://play.google.com/store/apps/details?id=br.jus.tse.eleitoral.etitulo&hl=pt_BR&gl=US) e [**App Store**](https://apps.apple.com/br/app/e-t%C3%ADtulo/id1320338088). O aplicativo funciona tanto no sistema operacional Android quanto no iOS.
