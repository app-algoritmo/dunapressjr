...
Quem tem interesse em participar deve acessar a[** página do mutirão**](https://meubolsoemdia.com.br/Materias/mutirao-da-negociacao). Lá, e possível acessar o [**Registrato**](https://registrato.bcb.gov.br/registrato/login/), sistema do Banco Central que leva à lista de dívidas em nome do consumidor.

As dívidas, segundo a Febraban, podem ser negociadas diretamente com o banco ou por meio do [**P**](http://www.consumidor.gov.br/pages/principal/?1669301102873)[**ortal ConsumidorGovBr**](https://www.consumidor.gov.br/pages/principal/?1669301102873). Os interessados devem apresentar uma proposta de negociação à instituição credora. O banco tem até 10 dias para analisar a solicitação e apresentar uma resposta.
