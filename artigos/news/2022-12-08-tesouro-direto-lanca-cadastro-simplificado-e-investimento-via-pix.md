...
### Novas funcionalidades permitem aplicações em menos de 5 minutos.

A partir desta quarta-feira (7), os investidores do Tesouro Direto, programa de venda de títulos públicos a pessoas físicas, podem fazer um cadastro simplificado e quitar os investimentos via Pix. O Tesouro Nacional lançou funcionalidades que pretendem simplificar os investimentos e permitir aplicações em menos de 5 minutos.

Chamado de Cad&Pag, o novo sistema, disponível no [**Portal do Tesouro Direto**](https://portalinvestidor.tesourodireto.com.br/cadastro), une as funcionalidades de cadastro simplificado e de aportes financeiros via Pix. Todo o processo é feito sem sair do site do programa.
...
Em relação ao método de pagamento, o Cad&Pag usa o [**PagTesouro, sistema da Secretaria do Tesouro Nacional que permite pagamentos pelo Pix**](https://agenciabrasil.ebc.com.br/economia/noticia/2022-08/mais-de-40-orgaos-federais-aceitam-pagamento-de-taxas-pix). Todos os investidores que se cadastrarem pelo cadastro simplificado terão acesso a essa ferramenta.
