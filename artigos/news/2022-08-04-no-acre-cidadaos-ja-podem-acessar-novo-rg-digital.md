...
Depois de emitir a nova carteira nos órgãos estaduais, o cidadão deve baixar o app Gov.Br nas lojas de aplicativos disponíveis para sistemas operacionais iOS ou Android. [**Após inserir o usuário e a senha no aplicativo**](https://www.gov.br/governodigital/pt-br/conta-gov-br), aparecerá uma tela inicial com o ícone "Carteira de documentos". A partir daí, basta clicar no botão "+"; escolher "Carteira de Identidade" e ir em "Adicionar Documento" para ter acesso.
