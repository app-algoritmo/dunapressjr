...
O presidente da Caixa anunciou que uma nova atualização do aplicativo Caixa Auxílio Emergencial, liberada nesta segunda-feira (20) para dispositivos móveis do sistema Android e terça-feira (21) para o sistema iOS, permitirá que o usuário conteste benefícios negados e refaça o cadastro no aplicativo, com a correção de dados. A atualização do cadastro já está disponível para o aplicativo e o site [auxilio.caixa.gov.br](http://auxilio.caixa.gov.br/), não nas agências bancárias.
