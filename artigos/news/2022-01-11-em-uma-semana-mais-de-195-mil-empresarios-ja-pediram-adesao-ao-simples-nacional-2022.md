...
A opção pelo Simples Nacional pode ser feita por microempresas e empresas de pequeno porte até o dia 31 de janeiro. No entanto, os solicitantes não podem fazer parte das vedações previstas na [Lei Complementar nº 123, de 2006](http://www.planalto.gov.br/ccivil_03/leis/lcp/lcp123.htm). O acesso ao sistema para opção é realizado por meio do [Portal do Simples Nacional](http://www8.receita.fazenda.gov.br/simplesnacional/Default.aspx) (em Simples - Serviços > Opção > Solicitação de Opção pelo Simples Nacional)

Para as empresas já em atividade, a solicitação de opção pode ser feita até o último dia útil (31). Caso aceita, valerá a partir de 1° de janeiro deste ano (caráter retroativo).
