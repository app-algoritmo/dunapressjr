...
Os cerca de 4,5 milhões de associados ao Sicredi podem ter acesso direto a serviços públicos digitais com a mesma senha do aplicativo da instituição. A cooperativa de crédito tornou-se a 10ª instituição financeira a ser integrada ao [**Portal Gov.br**](https://acesso.gov.br/).
