...
Para que o treinamento se tornasse algo quantificado, não apenas qualitativo, estou finalizando a criação do dispositivo que apoiará tanto o profissional no acompanhamento da evolução do paciente, quanto o usuário no treinamento em trajetos longos, para superação de desafios. Além disso, ele funciona em tempo real e via *bluetooth*, transmitindo os dados para o computador com o programa em questão.
