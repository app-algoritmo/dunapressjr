...
Além de divulgar o Relatório Resumido de Execução Orçamentária (RREO) dos estados e do DF, o Tesouro Nacional lançou nesta segunda-feira um painel das contas estaduais. A [**página**](https://www.tesourotransparente.gov.br/visualizacao/painel-do-rreo-em-foco-estados-df) RREO em Foco Estados + Distrito Federal está no ar no portal Tesouro Transparente e permitirá consultas e pesquisas a partir de 2015. O painel será atualizado a cada dois meses, com base nas informações prestadas pelos estados e pelo Distrito Federal.
