...
Os sistemas de parcelamento serão atualizados e centralizados no [**portal e-CAC**](https://cav.receita.fazenda.gov.br/autenticacao/login). Como a unificação será acompanhada da opção de desistência, será possível negociar o reparcelamento das dívidas também no e-CAC.
...
“Vale lembrar, também, que as regras não se aplicam às dívidas de tributos do Simples Nacional e MEI (declaradas em PGDAS-D ou DASN-SIMEI), que seguem as regras constantes da [**Resolução CGSN 140/2018**](http://normas.receita.fazenda.gov.br/sijut2consulta/link.action?idAto=92278)”, acrescenta.
