...
Para facilitar a localização dos dados pelos interessados, o painel distribui as informações em cinco tipos de consulta diferentes: aquisição de bens, aquisição de insumos, contratação de serviços, comparativos e análises. Além disso, é possível aplicar filtros aos resultados, tais como região, estado, município, esfera administrativa e área de atuação, como Saúde e Educação, por exemplo. 
...
Dessa forma, é possível, por exemplo, que algum contrato indicado no painel tenha sido cancelado ou suspenso pelo gestor, e o valor, portanto, não tenha sido aplicado nas respectivas aquisições indicadas na contratação. 

A CGU está aberta a receber sugestões de aprimoramentos e de evolução da ferramenta. Quem tiver interesse em contribuir pode enviar as sugestões por meio da plataforma [FalaBR](https://sistema.ouvidorias.gov.br/publico/Manifestacao/SelecionarTipoManifestacao.aspx?ReturnUrl=%2f). 
