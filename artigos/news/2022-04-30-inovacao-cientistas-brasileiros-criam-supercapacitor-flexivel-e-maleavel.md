...
“A importância do [CAPES PrInt](https://www.gov.br/capes/pt-br/acesso-a-informacao/acoes-e-programas/bolsas/bolsas-e-auxilios-internacionais/informacoes-internacionais/programa-institucional-de-internacionalizacao-capes-print) vai além do material que foi possível produzir. Eu tive uma experiência única, aprendi novas formas de trabalhar, criei conexões e muitos outros trabalhos estão sendo desenvolvidos a partir da parceria que foi firmada entre Brasil e Inglaterra”, conclui Balboni.

**Programa Institucional de Internacionalização - PrInt**
O [PrInt](https://www.gov.br/capes/pt-br/acesso-a-informacao/acoes-e-programas/bolsas/bolsas-e-auxilios-internacionais/informacoes-internacionais/programa-institucional-de-internacionalizacao-capes-print) incentiva a construção, implementação e consolidação de planos estratégicos de internacionalização das instituições selecionadas, além da formação de redes de pesquisas internacionais para melhorar a qualidade da produção acadêmica vinculada à pós-graduação. O Programa também promove a mobilidade acadêmica de professores e estudantes de doutorado e pós-doutorado.
