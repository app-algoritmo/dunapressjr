...
O extrato pode ser conferido no [**Centro de Atendimento Virtual (e-CAC)**](https://cav.receita.fazenda.gov.br/) da Receita Federal. Para ter acesso ao *site*, o contribuinte deve informar ou o certificado digital (se tiver um), ou o *login* no Portal Gov.br ou digitar número do CPF/CNPJ, o código de acesso e a senha.
