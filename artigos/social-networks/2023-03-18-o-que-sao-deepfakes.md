...
Tomemos, por exemplo, [o GPT-2 -](https://openai.com/blog/better-language-models/) o último tipo de sistema de geração de texto lançado pelo laboratório de pesquisa OpenAI do Vale do Silício. Essa tecnologia impressionou tanto o leigo quanto os especialistas de domínio com sua capacidade de produzir texto coerente com prompts mínimos.
...
Pesquisadores do Allen Institute for Artificial Intelligence desenvolveram uma ferramenta de software chamada [Grover](http://web.archive.org/web/20201001134554/https://grover.allenai.org/) para detectar conteúdo sintético flutuando online. Os pesquisadores afirmam que este software é capaz de detectar ensaios escritos por deepfake em 92% das vezes. Grover trabalha em um conjunto de teste compilado do Common Crawl, um arquivo e rastreador da web de código aberto. Da mesma forma, uma equipe de cientistas de Harvard e do laboratório MIT-IBM Watson se uniram para projetar o [Giant Language Model Test Room](http://gltr.io/dist/index.html), uma ferramenta da web que busca discernir se o texto inserido é gerado por IA.
...
A IA de geração de vídeo moderna é mais capaz e talvez mais perigosa do que sua contraparte de linguagem natural. A empresa de tecnologia Hyperconnect, com sede em Seul, desenvolveu recentemente uma ferramenta chamada [MarioNETte](https://hyperconnect.github.io/MarioNETte/) que pode gerar vídeos deepfake de figuras históricas, celebridades e políticos. Isso é feito por meio da reconstituição facial de outra pessoa, cujas expressões faciais são sobrepostas à personalidade-alvo cujo deepfake será criado.
...
Por exemplo, considere este vídeo de demonstração deepfake de Obama lançado pelo Buzzfeed em 2018, que deixou os espectadores estupefatos em todo o mundo. [Você pode conferir aqui:](https://youtu.be/cQ54GDm1eL0)
...
Por exemplo, no ano passado, os desenvolvedores da startup de tecnologia *Resemble* desenvolveram uma ferramenta de código aberto chamada [Resemblyzer](https://github.com/resemble-ai/Resemblyzer) para a detecção de clipes de áudio deepfake. O Resemblyzer usa algoritmos avançados de aprendizado de máquina para derivar representações de computação de amostras de voz para prever se são reais ou falsas. Sempre que um usuário envia um arquivo de áudio para avaliação, ele gera uma representação matemática resumindo as características únicas da amostra de voz enviada. Por meio dessa conversão, torna-se possível que a máquina detecte se a voz é real ou produzida artificialmente por ferramentas deepfake.
...
### Saber mais: [Um público bem informado é um pré-requisito para a democracia](https://dunapress.org/2021/01/29/um-publico-bem-informado-e-um-pre-requisito-para-a-democracia/)
