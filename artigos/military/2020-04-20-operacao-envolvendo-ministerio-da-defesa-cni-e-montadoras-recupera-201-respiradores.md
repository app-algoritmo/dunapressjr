...
A ação logística é promovida pelo Ministério da Defesa por meio da Secretaria de Produtos de Defesa (SEPROD) e da Chefia de Logística (CHELOG), e gerenciada pelo Centro de Coordenação de Logística e Mobilização (CCLM).
