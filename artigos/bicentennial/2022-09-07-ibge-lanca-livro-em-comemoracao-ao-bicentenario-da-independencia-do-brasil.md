...
O livro impresso será vendido e pode ser adquirido através da [loja virtual do IBGE](https://loja.ibge.gov.br/as-estatisticas-nas-comemoracoes-da-independencia-do-brasil.html). A obra também será disponibilizada em formato de e-book e poderá ser baixada gratuitamente na [Biblioteca IBGE](https://biblioteca.ibge.gov.br/index.php/biblioteca-catalogo?view=detalhes&id=2101932).
