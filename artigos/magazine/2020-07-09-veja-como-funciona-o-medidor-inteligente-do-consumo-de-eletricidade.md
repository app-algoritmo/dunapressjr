...
- A [NVE](https://www.nve.no/) (*Diretiva Norueguesa de Recursos Hídricos e Energia*) não fornece diretrizes para escolhas de tecnologia. Como existem muitos padrões para escolher, a NVE propõe que o próprio setor de energia se beneficie por limitar as possibilidades e coordenar suas escolhas.

Substituição do medidor de eletricidade: Foto Paul Kleiven NTB scanpix - Noruega
...
- [European Parliament calls for zero-energy buildings from 2019](http://www.euractiv.com/energy-efficiency/parliament-calls-zero-energy-bui-news-221594)
- [Departement of Energy - The Smart Grid an introduction](https://energy.gov/sites/prod/files/oeprod/DocumentsandMedia/DOE_SG_Book_Single_Pages.pdf)
- [Statistisk sentralbyrå](https://www.ssb.no/a/publikasjoner/pdf/oa_200806/ericson.pdf)
- [International Energy Agency](https://www.iea.org/w/bookshop/add.aspx?id=425)
- [NVE](https://www.nve.no/)
