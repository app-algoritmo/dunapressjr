...
Nesse caso, o dentista precisa avaliar se a posição do siso interfere no sorriso torto. Após os exames necessários, ele analisa a situação e planeja o melhor tratamento. "O ideal é consultar seu dentista para avaliar o que precisa ser feito. Existem casos em que o paciente precisa extrair os quatro dentes e existem outros, com a arcada espaçada, em que o nascimento dos sisos não interfere diretamente no alinhamento dos dentes", explica.
