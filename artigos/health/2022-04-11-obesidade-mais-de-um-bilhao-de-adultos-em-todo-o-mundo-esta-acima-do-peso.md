...
A obesidade é o excesso de gordura corporal em quantidade que determine prejuízos à saúde. A OMS define o diagnóstico pelo **[índice de massa corporal (IMC)](https://abeso.org.br/obesidade-e-sindrome-metabolica/calculadora-imc/)**, que é calculado utilizando a altura e o peso do indivíduo (IMC = peso (kg) / altura (m)2).
...
Para participar, **[acesse aqui o formulário](https://forms.gle/kMVbRfYFMs11BGKC7)**. Em apenas 5 minutos você responde às perguntas, lembrando que as respostas são mantidas em sigilo.
