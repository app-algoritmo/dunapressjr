...
**Controle integrado**
Os pesquisadores argumentam que a utilização de *Metarhizium humberi* tem como objetivo se integrar a outras formas de combate ao mosquito. “A gente sabe que não consegue controlar um vetor com uma ferramenta só. No caso do combate desse vetor, existem métodos químicos, físicos e estamos tentando implementar esse método biológico”, destaca Juscelino Rodrigues.
