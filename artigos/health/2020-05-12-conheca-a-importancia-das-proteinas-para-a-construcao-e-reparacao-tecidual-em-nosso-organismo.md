...
- Aminoácidos essenciais: não são sintetizados pelo organismo e devem ser fornecidos pela dieta, são 8 no total.
- Aminoácidos não essenciais: são os que são sintetizados pelo organismo a partir de outros a.a.s, são 13 no total.
