...
A partir do resíduo agroindustrial do sisal, por meio de processos extrativos foi obtida uma fração rica em polissacarídeos. Em seguida, essa fração foi avaliada quanto à sua segurança, bem como quanto à sua eficácia como um ativo antioxidante, por meio de inúmeros testes *in vitro* e *in vivo*. Por fim, essa fração foi incorporada a uma nanoemulsão previamente desenvolvida para compor uma nova formulação e, consequentemente, sua estabilidade, avaliada ao longo do tempo.
...
UFRN recebe patenteamento de tecnologia que utiliza resíduo de sisal (Foto: Arquivo pessoal)
...
Parte desse trabalho recebeu premiação como melhor trabalho no 32° Congresso Brasileiro de Cosmetologia (2020). Foi publicado no jornal *biomolecules com *Fator de impacto=6,064 (doi:10.3390/biom10101435). Além disso, possui carta patente para a formulação desenvolvida.
