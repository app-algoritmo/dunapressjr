...
É importante ter planejamento, escolher o local em que a atividade será feita, separar os candidatos em pequenos grupos e definir quais tecnologias e métodos serão usados para medir os resultados. Um [software de recrutamento](https://factorialhr.com.br/recrutamento-selecao), por exemplo, pode fazer a gestão dos processos seletivos e das ferramentas empregadas neles.
