...
A **UNIOIL – Universidade Corporativa Actioil** é a primeira plataforma EAD de formação na área de combustíveis, com aulas técnicas sobre gestão, manuseio, boas práticas e tratamento químico do diesel e biodiesel, processos de degradação, composição dos combustíveis, influência nos motores e seu caminho desde o tanque do veículo ou equipamento até o escapamento e suas emissões.

Segundo Gilles Grimberg, o Ensino a Distância (EAD) foi a ferramenta escolhida, devido ao momento, pois com a pandemia e a restrições de viagem, essa ferramenta permite treinar e levar conhecimento aos quatro cantos do Brasil, de forma simultânea e sem limites de acesso ou pessoas. "Trata-se de uma tendência irreversível, uma verdadeira revolução de costumes, que representará avanços importantes também para o treinamento empresarial", enfatiza.

A interface da UNIOIL oferece módulos específicos para cada um dos envolvidos e até protocolos de controles, com emissão de relatórios de participação, para que os gestores avaliem o andamento e o desempenho de suas equipes durante os cursos e módulos disponibilizados.

Com isto é possível fazer frente à diversas dificuldades que normalmente atrapalham os treinamentos, como reunir todo o time, tirar do foco da operação, custos elevados de viagem, instrutores, entre outros. Além disso, a capacitação contribuiu para diminuir a rotatividade de colaboradores, já que a curva de aprendizagem se torna eficaz e descomplicada quando há substituição de pessoas nas equipes envolvidas.
